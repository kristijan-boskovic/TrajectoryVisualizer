...
/**
 * Derived from: https://github.com/luborliu/TraClusAlgorithm/blob/master/src/boliu/ClusterGen.java
 *
...
public class ClusterGen {
	...
	class LineSegmentCluster {
		...
		ArrayList<CandidateClusterPoint> candidatePointList = new ArrayList<CandidateClusterPoint>();
		int nClusterPoints;
