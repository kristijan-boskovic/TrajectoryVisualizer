...
public class Converter {
    ...
    public static UTMCoordinate convertToUTM(LatLongLocation llc) throws Exception {

        double longitude = llc.getLongitude();
        double latitude = llc.getLattitude();

        validate(latitude, longitude);
        setVariablesLatLongToUTM(latitude, longitude);
...
//	public static LatLongLocation convertToLatLong(UTMCoordinate utmc) {
//
//		int longZone = Integer.parseInt(utmc.getLongZone());
//		String latZone = utmc.getLatZone();
...
//		}
//
//		setVariablesUTMToLatLong(easting, northing);
...
//		}
//
//		return new LatLongLocation(latitude, longitude);
//
//	}
    ...
    private static void setVariablesLatLongToUTM(double latitude, double longitude) {
...
//	}
    ...
    private static void setVariablesUTMToLatLong(double easting, double northing) {
